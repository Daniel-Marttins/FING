    ...
    setThemeData(prev => ({
      ...
      typography: {
        ...
        [section]: typeof prev.typography[section as keyof typeof prev.typography] === 'object' 
          ? { ...prev.typography[section as keyof typeof prev.typography], [field]: value }
          : value
      }
    }));
  };
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Customize a aparência do site do evento</p>
        </div>
        ...
        <TabsContent value="colors" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Escolha um esquema pré-definido ou customize suas próprias cores</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {Object.entries(colorSchemes).map(([key, scheme]) => (
                    <div
                      ...
                      className={`cursor-pointer border rounded-lg p-4 ${
                        selectedColorScheme === key ? 'border-primary' : 'border-border'
                      }`}
                  ...
                  <div
                    className={`cursor-pointer border rounded-lg p-4 ${
                      selectedColorScheme === 'custom' ? 'border-primary' : 'border-border'
                    }`}
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="space-y-4">
                    ...
                    {Object.entries(themeData.colors).slice(0, 6).map(([key, value]) => (
                  ...
                  <div className="space-y-4">
                    ...
                    {Object.entries(themeData.colors).slice(6).map(([key, value]) => (
                      <div key={key} className="flex items-center justify-between">
                        <Label className="capitalize">{key.replace(/([A-Z])/g, ' $1')}</Label>
                        <div className="flex items-center gap-2">
                          <Input
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure as fontes utilizadas no site</CardDescription>
              </CardHeader>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                {Object.entries(themeData.typography.fontSize).map(([key, value]) => (
                  <div key={key} className="space-y-2">
                    ...
                    <Slider
                      ...
                      onValueChange={([newValue]) => 
                        handleTypographyChange('fontSize', key, `${newValue}rem`)
                      }
                      min={0.5}
                      max={4}
                      step={0.125}
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure as dimensões do layout</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label>Raio das Bordas: {themeData.layout.borderRadius}px</Label>
                  <Slider
                ...
                <div className="space-y-2">
                  <Label>Altura do Header: {themeData.layout.headerHeight}px</Label>
                  <Slider
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleBrandingChange('logoSize', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Exibir slogan junto ao logo</p>
                  </div>
                  <Switch
                    checked={themeData.branding.showTagline}
                    onCheckedChange={(checked) => handleBrandingChange('showTagline', checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Usar cores da marca no logo</p>
                  </div>
                  <Switch
                    checked={themeData.branding.brandColors}
                    onCheckedChange={(checked) => handleBrandingChange('brandColors', checked)}
                  />
                </div>
              </CardContent>
            </Card>
        ...
        <TabsContent value="effects" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure os efeitos visuais do site</CardDescription>
            </CardHeader>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Usar gradientes em elementos</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label>Blur</Label>
                      <p className="text-sm text-muted-foreground">Efeitos de desfoque em fundos</p>
                    </div>
                    <Switch
                      checked={themeData.effects.blur}
                      onCheckedChange={(checked) => handleEffectChange('blur', checked)}
                    />
                  </div>
                </div>
              </div>
        ...
        <TabsContent value="preview" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Visualize como o tema ficará no site</CardDescription>
            </CardHeader>
            <CardContent>
