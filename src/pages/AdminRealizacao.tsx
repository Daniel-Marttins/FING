...
export default function AdminRealizacao() {
  ...
  const getTypeColor = (type: string) => {
    return (
      organizationTypes.find((t) => t.value === type)?.color || "bg-gray-500"
    );
  };
  ...
  const getCategoryColor = (category?: string) => {
    ...
    return (
      sponsorCategories.find((c) => c.value === category)?.color ||
      "bg-gray-500"
    );
  };
  ...
  const getCategoryLabel = (category?: string) => {
    if (!category) return "";
    return (
      sponsorCategories.find((c) => c.value === category)?.label || category
    );
  };
  ...
  const groupedOrganizations = organizations.reduce(
    (groups, org) => {
      const type = org.type;
      if (!groups[type]) {
        groups[type] = [];
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Gerencie organizadores, apoiadores e patrocinadores
          </p>
        </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setFormData((prev) => ({
                        ...prev,
                        type: value as Organization["type"],
                      }))
                    }
                  >
                    <SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setFormData((prev) => ({
                        ...prev,
                        category: value as Organization["category"],
                      }))
                    }
                  >
                    <SelectTrigger>
                      ...
                      <div key={org.id} className="border rounded-lg p-4">
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex items-center gap-2">
                            <Badge
                              className={`${getTypeColor(org.type)} text-white`}
                            >
                              {getTypeLabel(org.type)}
                            </Badge>
                            {org.category && (
                              <Badge
                                className={`${getCategoryColor(org.category)} text-white`}
                              >
                    ...
                    {orgs.length > 0 ? (
                      ...
                      <div className="flex flex-col items-center justify-center py-12">
                        ...
                        <h3 className="text-lg font-semibold mb-2">
                          Nenhum {type.label.toLowerCase()} cadastrado
                        </h3>
